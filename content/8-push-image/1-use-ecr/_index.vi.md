...
- Kiểm tra lại version của AWS CLI
...
Tại AWS console của **Push commands for fcjresbar-fe**
...
Tương tự, gắn tag phù hợp cho image và tiến hành đẩy image lên ECR.
